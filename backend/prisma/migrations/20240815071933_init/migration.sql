...
-- AddForeignKey
ALTER TABLE "Option" ADD CONSTRAINT "Option_task_int_fkey" FOREIGN KEY ("task_int") REFERENCES "Task"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
